export const AGENT_PROMPTS = {
  ...
  `,
    ...
    Your Focus: Summarize conflicts between other agents.
    Your Goal: Present trade-offs in plain language.
    Task: Read the opinions of all other agents. Identify where they disagree (e.g., Body Safety says 'rest' but Goal says 'push'). Explain this simply to the user. 
    Finally, give a "Safe Options" list.
  `
};
