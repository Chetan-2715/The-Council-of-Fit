...
const StyledWrapper = styled.div`
  ...
  align-items: center;
  height: 200px; /* Ensure sufficient height for the animation */
  width: 200px;  /* Ensure sufficient width */
  position: relative; 
  padding: 50px; /* Add padding to prevent clipping */
  ...
  .bubble4 {
    ...
    width: 20px;
    height: 20px;
    background: radial-gradient(circle at 30% 30%, #fffda3, #e6c820, #ffee58);
    border-radius: 50%;
    left: 14px;
